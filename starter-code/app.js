...
function sumArray(sumArr) { //eslint-disable-line
  let stepOne = sum(sumArr[0], sumArr[1]);
  let threeSum = sum(stepOne[0], sumArr[2]);
  let string = `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and ${threeSum[0]} is their sum.`;
  let array = [threeSum[0], string];
  return array;
}
...
function multiplyArray(multArr) { //eslint-disable-line
  let stepOne = multiply(multArr[0], multArr[1]);
  let stepTwo = multiply(stepOne[0], multArr[2]);
  let string = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${stepTwo[0]}.`;
  return [stepTwo[0], string];
}
